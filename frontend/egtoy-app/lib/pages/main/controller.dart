...
class MainController extends GetxController {
  ...
  asyncLoadAllData() async {
    ...
    // state.newsRecommend = await NewsAPI.newsRecommend(cacheDisk: true);
    // state.newsPageList = await NewsAPI.newsPageList(cacheDisk: true);

    //state.selCategoryCode = state.categories.first.code;
  }

  // 拉取推荐、新闻
  asyncLoadNewsData(categoryCode, {bool refresh = false}) async {
